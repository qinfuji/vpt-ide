...
(function(t, n) {
    ...
    return (
      ...
      (e.tickArguments = function(t) {
        return arguments.length
          ? ((r = null == t ? [] : js.call(t)), e)
          : r.slice();
      }),
      (e.tickValues = function(t) {
        return arguments.length
          ? ((i = null == t ? null : js.call(t)), e)
          : i && i.slice();
      }),
                ...
                : (n = gf.exec(t))
                  ...
                  : (n = _f.exec(t))
                    ...
                    : (n = yf.exec(t))
                      ...
                      : mf.hasOwnProperty(t)
                        ? St(mf[t])
                        : 'transparent' === t ? new zt(NaN, NaN, NaN, 0) : null
    );
  }
  function St(t) {
  ...
  function Jt(t, n) {
    var e = n - t;
    return e
      ? Qt(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e)
      : Gt(isNaN(t) ? n : t);
  }
  function Kt(t) {
    return 1 == (t = +t)
  ...
  function bn() {
    _n(), ++ul;
    for (var t, n = Ff; n; )
      (t = ll - n._time) >= 0 && n._call.call(null, t), (n = n._next);
    --ul;
  }
  function wn() {
  ...
  function Tn(t) {
    if (!ul) {
      ...
      t - ll > 24
        ? (t < 1 / 0 && (al = setTimeout(wn, t - pl.now() - hl)),
          cl && (cl = clearInterval(cl)))
        : (cl || ((fl = pl.now()), (cl = setInterval(Mn, sl))),
          (ul = 1),
          dl(wn));
    }
  }
    ...
    (function(t, n, e) {
      function r(c) {
        ...
        if (
          (Nn(function() {
            e.state === xl &&
              ((e.state = bl), e.timer.restart(i, e.delay, e.time), i(c));
          }),
          (e.state = ml),
          ...
          for (
            e.state = xl, u = new Array((l = e.tween.length)), s = 0, f = -1;
            s < l;
            ++s
          )
  ...
  function Pn(t, n) {
    ...
    return ('number' == typeof n
      ? on
      : n instanceof kt ? Yf : (e = kt(n)) ? ((n = e), Yf) : an)(t, n);
  }
  function Rn(t, n, e, r) {
  ...
  function Yn(t) {
    return (t = +t) < Pl
      ...
      : t < Ll
        ? Yl * (t -= Rl) * t + ql
        : t < Ul ? Yl * (t -= Dl) * t + Ol : Yl * (t -= Fl) * t + Il;
  }
  function Bn(t, n) {
      ...
      (e.extent = function(t) {
        return arguments.length
          ? ((s =
              'function' == typeof t
                ? t
                : Hn([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]])),
            e)
          : s;
      }),
      (e.filter = function(t) {
        return arguments.length
          ? ((f = 'function' == typeof t ? t : Hn(!!t)), e)
          : f;
      }),
    ...
    function n(t, n) {
      function e() {
        ...
        if (t.charCodeAt(r) === wh) {
          for (
            ;
            (a++ < u && t.charCodeAt(a) !== wh) || t.charCodeAt(++a) === wh;
      ...
      var r,
        ...
        f = !1;
      for (
        t.charCodeAt(u - 1) === Mh && --u, t.charCodeAt(u - 1) === Th && --u;
        (r = e()) !== bh;
  ...
  function Oe(n) {
    return (
      (Yh = Ue(n)),
      (t.format = Yh.format),
      (t.formatPrefix = Yh.formatPrefix),
      Yh
    );
  }
  function Fe(t) {
  ...
  function Ie(t, n) {
    return Math.max(
      0,
      3 * Math.max(-8, Math.min(8, Math.floor(Pe(n) / 3))) - Pe(Math.abs(t))
    );
  }
  function Ye(t, n) {
    return (
      (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, Pe(n) - Pe(t)) + 1
    );
  }
  function Be() {
    return new He();
  ...
  function Ur(t) {
    ...
    return (
      ...
      (n.invert = function(n) {
        return (
          (n = t.invert(n[0] * Ep, n[1] * Ep)), (n[0] *= Sp), (n[1] *= Sp), n
        );
      }),
      n
    );
  ...
  function Hr(t, n, e, r, i) {
    ...
    if (
      ...
      for (c.sort(n), jr(a), jr(c), o = 0, u = c.length; o < u; ++o)
        c[o].e = e = !e;
      for (var s, f, l = a[0]; ; ) {
  ...
  function Wr(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - Tp - bp : Tp - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - Tp - bp : Tp - n[1])
    );
  }
  function Zr(t) {
    function n(t, n) {
    ...
    return function(u) {
      ...
      function s(o, u) {
        ...
        if ((l && h.push([o, u]), x))
          ...
          var c = [
              (_ = Math.max(sd, Math.min(cd, _))),
              (y = Math.max(sd, Math.min(cd, y)))
            ],
            s = [
              (o = Math.max(sd, Math.min(cd, o))),
              (u = Math.max(sd, Math.min(cd, u)))
            ];
  ...
  function fi() {
    ...
    return (
      ...
      t
        .extentMajor([[-180, -90 + bp], [180, 90 - bp]])
        .extentMinor([[-180, -80 - bp], [180, 80 + bp]])
    );
  }
  function li(t) {
    return t;
    ...
    return +n
      ? (function(t, n) {
          function e(r, i, o, u, a, c, s, f, l, h, p, d, v, g) {
            ...
            if (m > 4 * n && v--) {
              var x = u + h,
                ...
                T = Ve((w /= M)),
                N =
                  Ap(Ap(w) - 1) < bp || Ap(o - l) < bp ? (o + l) / 2 : zp(b, x),
                k = t(N, T),
                S = k[0],
                E = k[1],
                A = S - r,
          ...
          return function(n) {
            ...
            function s() {
              e(_, y, g, m, x, b, l, h, f, p, d, v, Yd, n),
                (w.lineEnd = u),
                u();
            }
            var f,
    ...
    for (null == n && (n = so); (e = s.pop()); )
      if ((c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length)))
        for (e.children = new Array(u), o = u - 1; o >= 0; --o)
          s.push((r = e.children[o] = new ho(i[o]))),
            (r.parent = e),
            (r.depth = e.depth + 1);
  ...
  function To(t) {
    ...
    t: for (a = 3; a < i; ++a) {
      ...
      for (
        r.previous = n, r.next = e, n.next = e.previous = e = r, o = wo(n);
        (r = r.next) !== e;
  ...
  function Ho(t, n, e, r, i, o) {
    for (
      ...
      _.push((u = { value: f, dice: c < s, children: y.slice(m, x) })),
        u.dice
          ? Ro(u, e, r, i, w ? (r += s * f / w) : o)
          : Bo(u, e, r, w ? (e += c * f / w) : i, o),
        (w -= f),
        (m = x);
    }
    return _;
              ...
              return function(e, r) {
                t._tasks[n] &&
                  ...
                  null == t._error &&
                    (null != e
                      ? Zo(t, e)
                      : ((t._data[n] = r), t._waiting ? Wo(t) : Go(t))));
              };
            })(t, n)),
              --t._waiting,
              ++t._active,
  ...
  function lu(t, n) {
    function e() {
      return (
        (i = Math.min(a.length, c.length) > 2 ? su : cu), (o = u = null), r
      );
    }
    function r(n) {
      return (o ||
  ...
  function wu() {
    function n() {
      return (
        (o = xu(i)), (u = mu(i)), r()[0] < 0 && ((o = bu(o)), (u = bu(u))), e
      );
    }
    ...
    return (
      ...
      e &&
        ((i.count = function(n, r) {
          return (
            yv.setTime(+n), mv.setTime(+r), t(yv), t(mv), Math.floor(e(yv, mv))
          );
        }),
        (i.every = function(t) {
          return (
  ...
  function Au(t) {
    return Eu(
      ...
      function(t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * wv) / Mv
        );
      }
    );
  }
  ...
  function Lu(t) {
    ...
    function e(t, n) {
      return function(e) {
        ...
        return 'Z' in u
          ? ((u.H += (u.Z / 100) | 0), (u.M += u.Z % 100), Pu(u))
          : n(u);
      };
    }
    function r(t, n, e, r) {
      for (var i, o, u = 0, a = n.length, c = e.length; u < a; ) {
        ...
        if (37 === (i = n.charCodeAt(u++))) {
          if (
            ((i = n.charAt(u++)),
            !(o = T[i in bg ? n.charAt(u++) : i]) || (r = o(t, e, r)) < 0)
          )
            return -1;
  ...
  function va(t, n) {
    var e = t.getDay();
    return (
      (t = e >= 4 || 0 === e ? Dv(t) : Dv.ceil(t)),
      qu(Dv.count(Wv(t), t) + (4 === Wv(t).getDay()), n, 2)
    );
  }
  function ga(t) {
    return t.getDay();
  ...
  function Pa(t, n) {
    var e = t.getUTCDay();
    return (
      (t = e >= 4 || 0 === e ? ug(t) : ug.ceil(t)),
      qu(ug.count(yg(t), t) + (4 === yg(t).getUTCDay()), n, 2)
    );
  }
  function Ra(t) {
    return t.getUTCDay();
  ...
  function uc() {
    ...
    return (
      (t.x = function(e) {
        return arguments.length
          ? ((n = 'function' == typeof e ? e : Wa(+e)), t)
          : n;
      }),
      (t.y = function(n) {
        return arguments.length
          ? ((e = 'function' == typeof n ? n : Wa(+n)), t)
          : e;
      }),
      (t.defined = function(n) {
        return arguments.length
          ? ((r = 'function' == typeof n ? n : Wa(!!n)), t)
          : r;
      }),
      (t.curve = function(n) {
  ...
  function ac() {
    ...
    return (
      (t.x = function(n) {
        return arguments.length
          ? ((e = 'function' == typeof n ? n : Wa(+n)), (r = null), t)
          : e;
      }),
      (t.x0 = function(n) {
        return arguments.length
      ...
      (t.x1 = function(n) {
        return arguments.length
          ? ((r = null == n ? null : 'function' == typeof n ? n : Wa(+n)), t)
          : r;
      }),
      (t.y = function(n) {
        return arguments.length
          ? ((i = 'function' == typeof n ? n : Wa(+n)), (o = null), t)
          : i;
      }),
      (t.y0 = function(n) {
        return arguments.length
          ? ((i = 'function' == typeof n ? n : Wa(+n)), t)
          : i;
      }),
      (t.y1 = function(n) {
        return arguments.length
          ? ((o = null == n ? null : 'function' == typeof n ? n : Wa(+n)), t)
          : o;
      }),
  ...
  function yc(t) {
    ...
    return (
      ...
      (n.x = function(t) {
        return arguments.length
          ? ((i = 'function' == typeof t ? t : Wa(+t)), n)
          : i;
      }),
      (n.y = function(t) {
        return arguments.length
          ? ((o = 'function' == typeof t ? t : Wa(+t)), n)
          : o;
      }),
  ...
  function Oc(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      a = (o * i + u * r) / (r + i);
    return (
      (Uc(o) + Uc(u)) * Math.min(Math.abs(o), Math.abs(u), 0.5 * Math.abs(a)) ||
      0
    );
  }
  function Fc(t, n) {
  ...
  function vs(t) {
    var n = t.circle;
    n &&
      (n.P || (C_ = n.N), R_.remove(n), q_.push(n), es(n), (t.circle = null));
  }
  function gs(t) {
    var n =
      D_.pop() ||
  ...
  function ys(t) {
    ...
    for (
      var c = o;
      c.circle &&
      Math.abs(e - c.circle.x) < U_ &&
      Math.abs(r - c.circle.cy) < U_;
    ...
    for (
      var s = u;
      s.circle &&
      Math.abs(e - s.circle.x) < U_ &&
      Math.abs(r - s.circle.cy) < U_;
    ...
    var f,
      l = a.length;
    for (f = 1; f < l; ++f)
      (s = a[f]), (c = a[f - 1]), cs(s.edge, c.site, s.site, i);
    (c = a[0]),
      ((s = a[l - 1]).edge = us(c.site, s.site, null, i)),
      ds(c),
      ds(s);
  }
  function ms(t) {
    ...
    if ((z_.insert(n, c), n || e)) {
      ...
      if (e) {
        ...
        cs(e.edge, s, d, x),
          (c.edge = us(s, t, null, x)),
          (e.edge = us(t, d, null, x)),
          ds(n),
          ds(e);
    ...
    if (
      ...
      (function(t, n, e, r) {
        for (var i, o = L_.length; o--; )
          (fs((i = L_[o]), t, n, e, r) &&
            ss(i, t, n, e, r) &&
            (Math.abs(i[0][0] - i[1][0]) > U_ ||
              Math.abs(i[0][1] - i[1][1]) > U_)) ||
            delete L_[o];
      })(u, a, c, s),
        (function(t, n, e, r) {
          var i,
          ...
          for (i = 0; i < g; ++i)
            (o = P_[i]) && (o.halfedges.length || delete P_[i]);
        })(u, a, c, s);
    }
  ...
  if (((t.event = null), 'undefined' != typeof document)) {
    'onmouseenter' in document.documentElement ||
      (of = { mouseenter: 'mouseover', mouseleave: 'mouseout' });
  }
  X.prototype = {
    constructor: X,
  ...
  (st.prototype = ft.prototype = {
    ...
    on: function(t, n, e) {
      var r,
        ...
        u = o.length;
      if (!(arguments.length < 2)) {
        for (a = n ? q : L, null == e && (e = !1), r = 0; r < u; ++r)
          this.each(a(o[r], n, e));
        return this;
      }
      ...
      function(t) {
        return 'none' === t
          ...
          : (qf ||
            ...
            (t = Uf.getComputedStyle(Df.appendChild(qf), null).getPropertyValue(
              'transform'
            )),
            Df.removeChild(qf),
            (t = t.slice(7, -1).split(',')),
  ...
  mn.prototype = xn.prototype = {
    ...
    restart: function(t, n, e) {
      ...
      (e = (null == e ? _n() : +e) + (null == n ? 0 : +n)),
        this._next ||
          If === this ||
          (If ? (If._next = this) : (Ff = this), (If = this)),
        (this._call = t),
        (this._time = e),
        Tn();
    },
  ...
  Rn.prototype = Ln.prototype = {
            ...
            'function' == typeof n
              ? (function(t, n, e) {
                  ...
                  return function() {
                    ...
                    return (
                      null == a &&
                        (this.style.removeProperty(t), (a = G(this, t))),
                      u === a
                        ? null
                        : u === r && a === i ? o : (o = n((r = u), (i = a)))
                    );
    ...
    tween: function(t, n) {
      ...
      if (((t += ''), arguments.length < 2)) {
        for (
          var r, i = An(this.node(), e).tween, o = 0, u = i.length;
          o < u;
          ++o
        )
  ...
  (qh.copy = function() {
    ...
    (qh.visit = function(t) {
      var n,
        ...
        c = this._root;
      for (
        c && a.push(new me(c, this._x0, this._y0, this._x1, this._y1));
        (n = a.pop());
    ...
    (qh.visitAfter = function(t) {
      ...
      for (
        this._root &&
        e.push(new me(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
  ...
  Oe({ decimal: '.', thousands: ',', grouping: [3], currency: ['$', ''] }),
    (He.prototype = {
      ...
      add: function(t) {
        je(xp, t, this.t),
          je(this, xp.s, this.s),
          this.s ? (this.t += xp.t) : (this.s = xp.t);
      },
      valueOf: function() {
        return this.s;
      }
  ...
  var Hh,
    ...
    Xp = {
      ...
      polygonEnd: function() {
        var t = +Hp;
        jp.add(t < 0 ? kp + t : t),
          (this.lineStart = this.lineEnd = this.point = We);
      },
      sphere: function() {
        jp.add(kp);
      }
  ...
  var Zp,
    ...
    Rd = {
      ...
      result: function() {
        var t = Pd
          ? [Cd / Pd, zd / Pd]
          : Ad ? [Sd / Ad, Ed / Ad] : kd ? [Td / kd, Nd / kd] : [NaN, NaN];
      ...
      switch (this._point) {
        ...
        default:
          this._context.moveTo(t + this._radius, n),
            this._context.arc(t, n, this._radius, 0, kp);
      }
    },
    result: We
  };
  ...
  var bv = xv.range,
    ...
    Cv = Eu(
      ...
      function(t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * wv) / 864e5
        );
      },
      function(t) {
        return t.getDate() - 1;
      ...
      insert: function(t, n) {
        ...
        for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
          e === (r = e.U).L
            ? (i = r.R) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (t = r))
              : (t === e.R && (rs(this, e), (e = (t = e).U)),
                (e.C = !1),
                (r.C = !0),
                is(this, r))
            : (i = r.L) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (t = r))
              : (t === e.L && (is(this, e), (e = (t = e).U)),
                (e.C = !1),
                (r.C = !0),
                rs(this, r)),
            (e = t.U);
          ...
          if (t && t.C) t.C = !1;
            ...
            do {
              ...
              if (t === i.L) {
                if (
                  ((n = i.R).C &&
                    ((n.C = !1), (i.C = !0), rs(this, i), (n = i.R)),
                  (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                  (n.R && n.R.C) ||
                    ((n.L.C = !1), (n.C = !0), is(this, n), (n = i.R)),
                    (n.C = i.C),
                    (i.C = n.R.C = !1),
                    rs(this, i),
                    (t = this._);
                ...
                ((n = i.L).C &&
                  ((n.C = !1), (i.C = !0), is(this, i), (n = i.L)),
                (n.L && n.L.C) || (n.R && n.R.C))
              ) {
                (n.L && n.L.C) ||
                  ((n.R.C = !1), (n.C = !0), rs(this, n), (n = i.L)),
                  (n.C = i.C),
                  (i.C = n.L.C = !1),
                  is(this, i),
                  (t = this._);
  ...
  (ks.prototype = Ns.prototype),
      ...
      function t(t) {
        ...
        for (i = 0; i <= d; ++i)
          ((v = g[i] = []).x0 = i > 0 ? h[i - 1] : s),
            (v.x1 = i < d ? h[i] : l);
        for (i = 0; i < u; ++i)
          s <= (o = a[i]) && o <= l && g[Ds(h, o, 0, d)].push(t[i]);
        return g;
      }
      var n = s,
        e = a,
        ...
        (t.thresholds = function(n) {
          return arguments.length
            ? ((r =
                'function' == typeof n
                  ? n
                  : Array.isArray(n) ? c(Fs.call(n)) : c(n)),
              t)
            : r;
        }),
        t
    ...
    (t.ribbon = function() {
      function t() {
        ...
        if (
          ...
          u.arc(0, 0, f, l, h),
          (l === g && h === _) ||
            (u.quadraticCurveTo(0, 0, v * sh(g), v * fh(g)),
            u.arc(0, 0, v, g, _)),
      ...
      return (
        (t.radius = function(n) {
          return arguments.length
            ? ((r = 'function' == typeof n ? n : Jn(+n)), t)
            : r;
        }),
        (t.startAngle = function(n) {
          return arguments.length
            ? ((i = 'function' == typeof n ? n : Jn(+n)), t)
            : i;
        }),
        (t.endAngle = function(n) {
          return arguments.length
            ? ((o = 'function' == typeof n ? n : Jn(+n)), t)
            : o;
        }),
        (t.source = function(e) {
    ...
    (t.nest = function() {
      function t(n, i, u, a) {
        ...
        for (
          var c, s, f, l = -1, h = n.length, p = o[i++], d = ae(), v = u();
          ++l < h;
    ...
    (t.drag = function() {
      ...
      function i() {
        lt(t.event.view).on('mousemove.drag mouseup.drag', null),
          gt(t.event.view, l),
          dt(),
          _.mouse('end');
      }
      function o() {
        if (p.apply(this, arguments)) {
          var n,
            ...
            o = r.length;
          for (n = 0; n < o; ++n)
            (e = c(r[n].identifier, i, ht, this, arguments)) &&
              (pt(), e('start'));
        }
      }
      function u() {
      ...
      return (
        (n.filter = function(t) {
          return arguments.length
            ? ((p = 'function' == typeof t ? t : _t(!!t)), n)
            : p;
        }),
        (n.container = function(t) {
          return arguments.length
            ? ((d = 'function' == typeof t ? t : _t(t)), n)
            : d;
        }),
        (n.subject = function(t) {
          return arguments.length
            ? ((v = 'function' == typeof t ? t : _t(t)), n)
            : v;
        }),
        (n.touchable = function(t) {
          return arguments.length
            ? ((g = 'function' == typeof t ? t : _t(!!t)), n)
            : g;
        }),
        (n.on = function() {
    ...
    (t.forceCollide = function(t) {
      ...
      return (
        ...
        (n.radius = function(e) {
          return arguments.length
            ? ((t = 'function' == typeof e ? e : ge(+e)), r(), n)
            : t;
        }),
        n
      );
    ...
    (t.forceLink = function(t) {
      ...
      return (
        ...
        (n.strength = function(t) {
          return arguments.length
            ? ((l = 'function' == typeof t ? t : ge(+t)), r(), n)
            : l;
        }),
        (n.distance = function(t) {
          return arguments.length
            ? ((h = 'function' == typeof t ? t : ge(+t)), i(), n)
            : h;
        }),
        n
      );
    ...
    (t.forceManyBody = function() {
      ...
      return (
        ...
        (t.strength = function(e) {
          return arguments.length
            ? ((c = 'function' == typeof e ? e : ge(+e)), n(), t)
            : c;
        }),
    ...
    (t.forceRadial = function(t, n, e) {
      ...
      return (
        ...
        (r.strength = function(t) {
          return arguments.length
            ? ((c = 'function' == typeof t ? t : ge(+t)), i(), r)
            : c;
        }),
        (r.radius = function(n) {
          return arguments.length
            ? ((t = 'function' == typeof n ? n : ge(+n)), i(), r)
            : t;
        }),
        (r.x = function(t) {
    ...
    (t.forceX = function(t) {
      ...
      return (
        ...
        (n.strength = function(t) {
          return arguments.length
            ? ((u = 'function' == typeof t ? t : ge(+t)), e(), n)
            : u;
        }),
        (n.x = function(r) {
          return arguments.length
            ? ((t = 'function' == typeof r ? r : ge(+r)), e(), n)
            : t;
        }),
        n
      );
    ...
    (t.geoBounds = function(t) {
      var n, e, r, i, o, u, a;
      if (
        ((Qh = Gh = -(Wh = Zh = 1 / 0)), (ep = []), Je(t, $p), (e = ep.length))
      ) {
        ...
        for (u = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
          (i = o[n]),
            (a = _r(r[1], i[0])) > u && ((u = a), (Wh = i[0]), (Gh = r[1]));
      }
      return (
        (ep = rp = null),
        Wh === 1 / 0 || Zh === 1 / 0
    ...
    (t.geoCircle = function() {
      ...
      return (
        (t.center = function(n) {
          return arguments.length
            ? ((r = 'function' == typeof n ? n : Cr([+n[0], +n[1]])), t)
            : r;
        }),
        (t.radius = function(n) {
          return arguments.length
            ? ((i = 'function' == typeof n ? n : Cr(+n)), t)
            : i;
        }),
        (t.precision = function(n) {
          return arguments.length
            ? ((o = 'function' == typeof n ? n : Cr(+n)), t)
            : o;
        }),
        t
      );
    ...
    (t.geoPath = function(t, n) {
      ...
      return (
        ...
        (e.projection = function(n) {
          return arguments.length
            ? ((r = null == n ? ((t = null), li) : (t = n).stream), e)
            : t;
        }),
    ...
    (t.geoIdentity = function() {
      ...
      return (u = {
        ...
        scale: function(n) {
          return arguments.length
            ? ((h = Ki((a = +n) * f, a * l, c, s)), t())
            : a;
        },
        translate: function(n) {
          return arguments.length
            ? ((h = Ki(a * f, a * l, (c = +n[0]), (s = +n[1]))), t())
            : [c, s];
        },
        reflectX: function(n) {
          return arguments.length
            ? ((h = Ki(a * (f = n ? -1 : 1), a * l, c, s)), t())
            : f < 0;
        },
        reflectY: function(n) {
          return arguments.length
            ? ((h = Ki(a * f, a * (l = n ? -1 : 1), c, s)), t())
            : l < 0;
        },
          ...
          if (n) {
            for (
              ...
              (c = Uo(c)),
                ...
                (h += c.m),
                (f += u.m);
            a && !Oo(u) && ((u.t = a), (u.m += l - f)),
              o && !Uo(c) && ((c.t = o), (c.m += s - h), (e = t));
          }
          return e;
        })(t, r, t.parent.A || e[0]);
      }
    ...
    (t.treemap = function() {
      ...
      return (
        ...
        (t.paddingTop = function(n) {
          return arguments.length
            ? ((c = 'function' == typeof n ? n : So(+n)), t)
            : c;
        }),
        (t.paddingRight = function(n) {
          return arguments.length
            ? ((s = 'function' == typeof n ? n : So(+n)), t)
            : s;
        }),
        (t.paddingBottom = function(n) {
          return arguments.length
            ? ((f = 'function' == typeof n ? n : So(+n)), t)
            : f;
        }),
        (t.paddingLeft = function(n) {
          return arguments.length
            ? ((l = 'function' == typeof n ? n : So(+n)), t)
            : l;
        }),
        t
      );
    ...
    (t.scaleTime = function() {
      return ja(Wv, Vv, Pv, Cv, Ev, kv, Tv, xv, t.timeFormat).domain([
        new Date(2e3, 0, 1),
        new Date(2e3, 0, 2)
      ]);
    }),
    (t.scaleUtc = function() {
      return ja(yg, gg, eg, tg, Jv, Gv, Tv, xv, t.utcFormat).domain([
        Date.UTC(2e3, 0, 1),
        Date.UTC(2e3, 0, 2)
      ]);
    }),
    ...
    (t.arc = function() {
        ...
        if ((c || (c = t = te()), l < f && ((s = l), (l = f), (f = s)), l > t_))
          if (d > r_ - t_)
            c.moveTo(l * Zg(h), l * Jg(h)),
              c.arc(0, 0, l, h, p, !v),
              f > t_ &&
                (c.moveTo(f * Zg(p), f * Jg(p)), c.arc(0, 0, f, p, h, v));
          else {
            var g,
              _,
              y = h,
      ...
      return (
        ...
        (t.padRadius = function(n) {
          return arguments.length
            ? ((i = null == n ? null : 'function' == typeof n ? n : Wa(+n)), t)
            : i;
        }),
        (t.startAngle = function(n) {
          return arguments.length
            ? ((o = 'function' == typeof n ? n : Wa(+n)), t)
            : o;
        }),
        (t.endAngle = function(n) {
          return arguments.length
    ...
    (t.stack = function() {
      ...
      return (
        (t.keys = function(e) {
          return arguments.length
            ? ((n = 'function' == typeof e ? e : Wa(o_.call(e))), t)
            : n;
        }),
        (t.value = function(n) {
          return arguments.length
        ...
        (t.order = function(n) {
          return arguments.length
            ? ((e =
                null == n ? Wc : 'function' == typeof n ? n : Wa(o_.call(n))),
              t)
            : e;
        }),
        (t.offset = function(n) {
    ...
    (t.active = function(t, n) {
      ...
      if (i) {
        n = null == n ? null : n + '';
        for (r in i)
          if ((e = i[r]).state > yl && e.name === n)
            return new Rn([[t]], Gl, n, +r);
      }
      return null;
    }),
    (t.interrupt = Cn),
    (t.voronoi = function() {
      function t(t) {
        return new Ms(
          t.map(function(r, i) {
            var o = [
              Math.round(n(r, i, t) / U_) * U_,
              Math.round(e(r, i, t) / U_) * U_
            ];
      ...
      return (
        ...
        (t.x = function(e) {
          return arguments.length
            ? ((n = 'function' == typeof e ? e : Jc(+e)), t)
            : n;
        }),
        (t.y = function(n) {
          return arguments.length
            ? ((e = 'function' == typeof n ? n : Jc(+n)), t)
            : e;
        }),
        (t.extent = function(n) {
          return arguments.length
    ...
    (t.zoom = function() {
              ...
              .on(
                ...
                function() {
                  ...
                  n.zoom(
                    'mouse',
                    y(
                      r(n.that.__zoom, (n.mouse[0] = F(n.that)), n.mouse[1]),
                      n.extent,
                      w
                    )
                  );
        ...
        if (g.apply(this, arguments)) {
          ...
          if (d && ((d = clearTimeout(d)), !o.touch1))
            return (
              o.end(),
              void (
                (i = lt(this).on('dblclick.zoom')) && i.apply(this, arguments)
              )
            );
          n &&
      ...
      return (
        ...
        (n.wheelDelta = function(t) {
          return arguments.length
            ? ((m = 'function' == typeof t ? t : Ts(+t)), n)
            : m;
        }),
        (n.filter = function(t) {
          return arguments.length
            ? ((g = 'function' == typeof t ? t : Ts(!!t)), n)
            : g;
        }),
        (n.touchable = function(t) {
          return arguments.length
            ? ((x = 'function' == typeof t ? t : Ts(!!t)), n)
            : x;
        }),
        (n.extent = function(t) {
          return arguments.length
